...
<head>
    ...
    <!-- SEO -->
    <title>Free Fitness Calculators | CoachProAI</title>
    <meta name="description" content="Use free fitness calculators for fat loss, muscle gain, calorie deficit, and more. Smart tools powered by CoachProAI.">
    <link rel="canonical" href="https://calculators.coachproai.com/">

    <!-- Open Graph -->
    <meta property="og:type"        content="website">
    <meta property="og:url"         content="https://calculators.coachproai.com/">
    <meta property="og:title"       content="Free Fitness Calculators | CoachProAI">
    <meta property="og:description" content="Use free fitness calculators for fat loss, muscle gain, calorie deficit, and more. Smart tools powered by CoachProAI.">
    ...
    <header class="site-header" role="banner">
        <div class="container">
            <div class="header-inner">
                ...
                <!-- Brand -->
                <a href="/" class="brand-logo" aria-label="CoachProAI Home">
                ...
                <div class="header-cta" style="display:flex;align-items:center;gap:0.75rem;">
                    <a href="https://coachproai.com/start" class="btn btn-primary btn-sm">Start Coaching</a>
    ...
    <footer class="site-footer" role="contentinfo">
        <div class="container">
            <div class="footer-inner">
                ...
                <p class="footer-copy">
                    &copy; <?php echo date('Y'); ?> CoachProAI. All rights reserved.
                </p>

                <nav class="footer-links" aria-label="Footer navigation">
                    <a href="/">Home</a>
                    <a href="#calculators">Calculators</a>
                    <a href="https://coachproai.com/privacy">Privacy Policy</a>
                    <a href="https://coachproai.com/contact">Contact</a>
                </nav>
